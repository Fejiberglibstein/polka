...
pub const TextNode = struct {
    ...
    pub const toTyped = deriveToTyped(@This(), kind);
...
pub const ExportExpr = struct {
    ...
    pub fn getInner(self: ExportExpr, all_nodes: []const SyntaxNode) ExportInner {
        return castFirstChild(self.v, all_nodes, ExportInner) orelse unreachable;
    }
};
...
pub const LetExpr = struct {
    ...
    pub fn value(self: LetExpr, all_nodes: []const SyntaxNode) Expr {
        return castLastChild(self.v, all_nodes, Expr) orelse unreachable;
    }
};
...
pub const Binary = struct {
    ...
    pub fn op(self: Binary, all_nodes: []const SyntaxNode) BinaryOperator {
        return castFirstChild(self.v, all_nodes, BinaryOperator) orelse unreachable;
    }
};
...
pub const Unary = struct {
    ...
    pub fn op(self: Unary, all_nodes: []const SyntaxNode) UnaryOperator {
        return castFirstChild(self.v, all_nodes, UnaryOperator) orelse unreachable;
    }
};
...
pub const FunctionCall = struct {
    ...
    pub fn arguments(self: FunctionCall, all_nodes: []const SyntaxNode) ArgumentList {
        return castFirstChild(self.v, all_nodes, ArgumentList) orelse unreachable;
    }
};
...
pub const DotAccess = struct {
    ...
    pub fn rhs(self: DotAccess, all_nodes: []const SyntaxNode) Ident {
        return castLastChild(self.v, all_nodes, Ident) orelse unreachable;
    }
};
